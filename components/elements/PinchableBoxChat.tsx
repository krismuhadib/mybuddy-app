...
const PinchableBoxChat = ({ imageUri, item }) => {
          ...
          <Animated.View style={[
            ...
            onHandlerStateChange={_onPressHandlerStateChange}
             //onGestureEvent={onPressGestureEvent}
              >
                <Animated.View style={[
                  {marginLeft:0,width: ScreenWidth,height:"auto",
                    transform:[
                    ...
                    zIndex:1}]}>
                      ...
                      onGestureEvent={onPanGestureEvent}>
                        <Animated.View style={[{marginLeft:0,width: ScreenWidth,height:350,
                        transform:[
                          { translateX: translateX},
                          { translateY: translateY},
                        ],
...
export default PinchableBoxChat