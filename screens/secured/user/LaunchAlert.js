    ...
    <View style={styles.container}>
        ...
        >
          {(marker && marker !== undefined) &&
            <Marker coordinate={marker}>
              <MaterialIcons name="location-pin" size={30} color={Colors.green} />
            </Marker>
          }
      ...
      {(createMarker === false) &&
        <TouchableOpacity onPress={() => onCreatePin()}
          ...
          <MaterialIcons name="location-pin" size={30} color={Colors.red} />
        </TouchableOpacity>}
      ...
      {(createMarker === true) &&
        <View style={{ backgroundColor: Colors.white, position: "absolute", top: '20%', left: '3%', right: '5%', borderWidth: 2, borderColor: Colors.pinkBuddy, borderRadius: 12, height: 150, padding: 10, alignContent: "center", alignItems: 'center', justifyContent: 'center', }}>
          ...
          <View style={{}}>
            <View style={{ flexDirection: 'column', }}>
              ...
              <View style={{ flexDirection: "row", flex: 1, }}>
                ...
                <MaterialIcons style={{ top: -5, padding: 0 }} name="location-pin" size={30} color={Colors.red} />
              </View>

              <View style={{ flex: 1, flexDirection: 'row' }}>
                <Text style={BDiaryStyles.h5}>{i18n.t('launchAlert.savePinAlert')}</Text>
                <Feather style={{ top: 0, padding: 0 }} name="edit-3" size={30} color={Colors.red} />
              </View>
            </View>
...
export default LaunchAlertScreen;
