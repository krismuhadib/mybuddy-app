...
const AddAlertPictureScreen = (route) => {
  ...
  const storeDispatch = useDispatch();
   console.log("AddPictureScreen from: ", params.from, animalData)
  ...
  const goToRoot = () => {
      ...
      navigation.navigate('LaunchAlertScreen', {createMarkers: false, reload: true});
  ...
  return (
    <View style={BDiaryStyles.container}>
      ...
      <ScrollView>
        ...
        <View style={{width:"70%",marginRight:"15%", marginLeft:"15%", borderWidth:0,  marginTop: 0, marginBottom:0, alignContent:"center", alignItems: 'center', justifyContent:"center", }}>
          <BDButton
