...
import LikePostList from '../../../components/elements/LikePostList';
...
const AddComment = (route) => {
  ...
  console.log("AddComment animalData.blokedusers")
    ...
    fetch(config.uri + 'animals/getdatasfromanimalid', {
      ...
      .then((res) => {
        if (res.success === true) {
          ...
          console.log("ressss", res.animaldoc)
  ...
  const renderItem = (data, item) => {
    ...
    const commmenttoggleFav = (item) => { // Irst comment
            ...
            <View style={styles.inner}>
              ...
              <View style={{ borderWidth: 0 }}>
                ...
                <View>
                  ...
                  <View style={{ backgroundColor: "#FFF", flexDirection: 'row', height: 50, borderWidth: 0, position: "relative", }}>

                    <View style={{ zIndex: 0, }}>
                      <Text>qdsdqsdqsd</Text>
                       <LikeComment
