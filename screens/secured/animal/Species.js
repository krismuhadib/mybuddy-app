...
const SpeciesScreen = ( route ) => {
  ...
  console.log("Modal SpeciesScreen params", from, specify, i18n.locale)
  ...
  const CreateAnimal = async (item) => {
    ...
    if (item !== null) {
      ...
      // if (animalData !== undefined || animalData !== null &&  from === "change" ) {
      ...
      if (animalData && from === "User" ) {

        console.log("create AAnimal")
      ...
      if (animalData && from === "change" ) {

        console.log("modify AAnimal")
