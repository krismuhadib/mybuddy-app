      ...
      <View style={BDiaryStyles.card}>
        <View style={{ height: 110, justifyContent: 'center' }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={{ alignContent: "flex-start", alignItems: "flex-start", justifyContent: "flex-start", borderWidth: 0, top: 0, padding: 5, paddingRight: 15, }}>
              ...
              {(item.typeofmarkers === 1) &&
                <View style={styles.avatarPlaceholder}>
                  <Image
                    source={require('../../../assets/images/pin_health.png')}
                    size='small'
                    style={styles.avatar}
                  />
                </View>
              ...
              {(item.typeofmarkers === 2) &&
                <View style={styles.avatarPlaceholder}>
                  <Image
                    source={require('../../../assets/images/pin_store.png')}
                    size='small'
                    style={styles.avatar}
                  />
                </View>
              ...
              {(item.typeofmarkers === 4) &&
                <View style={styles.avatarPlaceholder}>
                  <Image
                    source={require('../../../assets/images/pin_outdoor.png')}
                    size='small'
                    style={styles.avatar}
                  />
                </View>
              ...
              {(item.typeofmarkers === 3) &&
                <View style={styles.avatarPlaceholder}>
                  <Image
                    source={require('../../../assets/images/pin_service.png')}
                    size='small'
                    style={styles.avatar}
                  />
                </View>
            ...
            onPress={() => goToMarkerDetails(item)}>
              <View style={{}}>
