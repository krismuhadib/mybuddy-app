...
export default class ModalConfirmationDeleteAvatar extends Component {
  
  constructor(props) {
    super(props);
    this.state = {
      modalDeleteActionVisible: false,
    ...
    console.log("MODAL ACTION DELETE AVATAR", this.state.postId, this.state.token)
  }
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    this.setState({
      modalDeleteActionVisible: nextProps.modalDeleteActionVisible,
  ...
  render() {
    ...
    const {modalDeleteActionVisible, visible} = this.state;
    ...
    var modalBackgroundStyle = {
        ...
        visible={ this.state.modalDeleteActionVisible }
        onRequestClose={() => {
          Alert.alert('Modal has been closed.');
            ...
            <View style={[styles.modalView]}>
              <View style={[styles.modalContent]}>
                <Text style={{ marginTop: 15, textAlign: 'center', fontSize: 15, fontWeight: 'bold' }}>{i18n.t('Modal.Delete_Confirmation')}</Text>
