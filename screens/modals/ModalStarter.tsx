...
export default class ModalStarter extends Component {
  
  constructor(props) {
    super(props);
    this.state = {
      modalStarterVisible: false,
      ...
      modalAnimalMiss: this.props.modalAnimalMiss,
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    this.setState({
      modalStarterVisible: nextProps.modalStarterVisible,
  ...
  render() {
    ...
    const {modalStarterVisible, visible} = this.state;
    ...
    var modalBackgroundStyle = {
       ...
       <View style={{backgroundColor:"white", justifyContent: 'center', paddingTop:20, padding:10}}> 
        <Text style={{ justifyContent: 'center', textAlign: 'center', color:"black",fontSize: 15, fontWeight: 'normal' }}>{this.state.modalText}</Text>
       </View>

       <View style={{backgroundColor:"white", justifyContent: 'center', padding:10}}> 
        <Text style={{ justifyContent: 'center', textAlign: 'center', color:"black",fontSize: 15, fontWeight: 'normal' }}>{this.state.modalAnimalMiss}</Text>
       </View>
       ...
       <View style={{flexDirection:'row', alignContent:"space-around"}}>
         ...
         <TouchableOpacity onPress={() => this._onClose()}>
            <Text style={{marginVertical:20, textAlign: 'center', color:'red', fontSize: 15, fontWeight: 'bold' ,  alignItems:'center',  justifyContent: "center", }}>{this.state.modalValid}</Text>
          </TouchableOpacity>
         </View>
