  ...
  render() {
   ...
   // console.log("RENDER MODAL DELETE postUpdatepostUpdatepostUpdatepostUpdatepostUpdatepostUpdate", postId)
    ...
    var modalBackgroundStyle = {
        ...
        <Text style={{ justifyContent: 'center', textAlign: 'center', color:"red",fontSize: 20, fontWeight: 'bold' }}>{i18n.t('Modal.Warning')}</Text>
       </View>

       <View style={{backgroundColor:"white", height:40, justifyContent: 'center',}}> 
        <Text style={{ justifyContent: 'center', textAlign: 'center', color:"black",fontSize: 15, fontWeight: 'normal' }}>{i18n.t('Modal.Warning_comment_message')}</Text>
       </View>
       ...
       <View style={{borderWidth:0,flex:1 }}>
         <TouchableOpacity onPress={() => this._onClose()}>
            <Text style={{marginVertical:20, textAlign: 'center', color:'red', fontSize: 15, fontWeight: 'bold' ,  alignItems:'center',  justifyContent: "center", }}>{i18n.t('Form.Cancel')}</Text>
          </TouchableOpacity>
         </View>
         
         <View style={{borderWidth:0, flex:1 }}>
         <TouchableOpacity onPress={() => this.GoToDeletePost()}>          
         <Text style={{marginVertical:20, textAlign: 'center', color:'red', fontSize: 15, fontWeight: 'bold' ,  alignItems:'center',  justifyContent: "center", }}>{i18n.t('Form.Delete')}</Text>
         </TouchableOpacity>
          </View>
