...
export default class ModalConfirmationDelete_dyn extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      modalFetch: this.props.modalFetch,
    ...
    console.log("MODAL ACTION DELETE DYN POSTUPDATE", this.state.postId)
  }
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    this.setState({
      ...
      animal_id: nextProps.animal_id,
      user_id: nextProps.user_id,
      modalTitle: nextProps.modalTitle,
      modalFetch: nextProps.modalFetch,
      image_id: nextProps.image_id,
      parentpost_id: nextProps.parentpost_id,
      postListNumber: nextProps.postListNumber,
    });
  }; 
  ...
  GoToDeletePost = async () => {
   ...
   console.log('Fetch postIdpostIdpostIdpostId', this.state.postId);
      ...
      fetch(config.uri+ this.state.modalFetch, {
      method: 'POST',
      headers: {
     ...
     //   token: this.state.token,
        ...
        user_id: this.state.user_id._id,
