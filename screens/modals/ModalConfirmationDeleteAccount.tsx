...
export default class ModalConfirmationDeleteAccount extends Component {
  ...
  constructor(props) {
    ...
    console.log("CONSTRUCTor MODAL ACTION DELETE ACCOUNT", this.state.user_id)
  }
  ...
  DeleteAccount = async () => {
    this.setState({
      ...
      fetch(config.uri+ 'users/delete_account', {
      method: 'POST',
      headers: {
     ...
     //   token: this.state.token,
      ...
      .then((res) => {
        if (res.success === true ) {
          ...
          //var user = res;
          console.log("RES ERASED ACCOUNT  ", res);
          ...
          const value = AsyncStorage.multiRemove(asynckeys)
      
         // this.props.removeUserToken();
          console.log("FINAL value erased", value)
  ...
  render() {
    ...
    //console.log("RENDER MODAL DELETE°DYN postUpdatepostUpdatepostUpdatepostUpdatepostUpdatepostUpdate", postId)
    ...
    var modalBackgroundStyle = {
       ...
       <View style={{backgroundColor:"white", justifyContent: 'center',}}> 
        <Text style={{ margin:10, justifyContent: 'center', textAlign: 'center', color: Colors.greyM,fontSize: 15, fontWeight: 'normal' }}>{i18n.t('Modal.Warning_Delete_Account')}</Text>
       </View>
